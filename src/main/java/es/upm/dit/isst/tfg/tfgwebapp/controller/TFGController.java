...
public class TFGController {
    ...
    public String lista(Model model, Principal principal) {
        ...
        if (principal == null || principal.getName().equals("")
            ...
            log.info(TFGMANAGER_STRING + "?tutor=" + principal.getName());
            lista = Arrays.asList(restTemplate.getForEntity(
    ...
    /*No incluyo los controles para subir un fichero correspondiente a la memoria del TFG para 
    almacenamiento como parte de éste cuando se
    alcanza el estado correspondiente, y el método para bajar ese fichero al navegador.
    Están en el enunciado.
    */
                ...
                try {
                    ...
                    if (respuestaEstado.getStatusCode() == HttpStatus.OK)
                    {
                        ...
                        restTemplate.exchange(
                            ...
                            new HttpEntity<>(file.getBytes(), headers), byte[].class);
                        }
                    }
                    } catch (Exception e) {
    ...
    public ResponseEntity<ByteArrayResource> getFile(
        ...
        try {
            ...
            if (tfg != null && tfg.getMemoria() != null) {
                ResponseEntity<byte[]> respuestaMemoria = restTemplate.exchange(TFGMANAGER_STRING + "/"
                        + alumno + "/memoria",
